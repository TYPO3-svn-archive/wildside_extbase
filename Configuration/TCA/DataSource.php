...
$TCA['tx_wildsideextbase_domain_model_datasource'] = array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'description' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.description',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
		...
		'query' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.query',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'func' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.func',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'url' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.url',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'url_method' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:wildside_extbase/Resources/Private/Language/locallang_db.xml:tx_wildsideextbase_domain_model_datasource.url_method',
			'config' => array(
				'type' => 'select',
				'items' => array(
					array('-- Label --', 0),
