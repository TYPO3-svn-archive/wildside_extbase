...
class Tx_WildsideExtbase_ViewHelpers_TagCloudViewHelper extends Tx_WildsideExtbase_Core_ViewHelper_AbstractViewHelper {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('tags', 'array', 'Optional list of tags. If no supplied the content of the ws:tagCloud tag becomes the tag list. 
			Other ViewHelpers included to register and count tags on-the-fly');
		$this->registerArgument('merge', 'string', 'If "argument", prevents gathering tags from the contents of the ws:tagCloud template tag ("argument" requires 
