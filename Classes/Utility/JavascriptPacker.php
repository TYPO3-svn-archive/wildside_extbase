...
class Tx_WildsideExtbase_Utility_JavascriptPacker {
	// constants
	const IGNORE = '$1';
	...
	public function pack($veryBasic = false) {
		if ($veryBasic) {
			$this->_addParser('_reallyBasicCompression');
		} else {
	...
	// zero encoding, fo' reals - just removal of comments
	// !!! THIS FUNCTION HAS BEEN PATCHED IN BY WILDSIDE !!!
	private function _reallyBasicCompression($script) {
