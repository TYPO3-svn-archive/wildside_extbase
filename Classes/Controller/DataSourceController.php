 ...
 */
 class Tx_WildsideExtbase_Controller_DataSourceController extends Tx_WildsideExtbase_Core_AbstractController {

	/**
	 * dataSourceRepository
	 *
	 * @var Tx_WildsideExtbase_Domain_Repository_DataSourceRepository
	 */
	protected $dataSourceRepository;
	
	/**
	 * 
	 * @var Tx_WildsideExtbase_Utility_DataSourceParser
	 */
	 ...
	 *
	 * @param Tx_WildsideExtbase_Domain_Repository_DataSourceRepository $dataSourceRepository
	 * @return void
	 */
	public function injectDataSourceRepository(Tx_WildsideExtbase_Domain_Repository_DataSourceRepository $dataSourceRepository) {
		$this->dataSourceRepository = $dataSourceRepository;
	}
	
	/**
	 * 
	 * @param Tx_WildsideExtbase_Utility_DataSourceParser $parser
	 */
	public function injectDataSourceParser(Tx_WildsideExtbase_Utility_DataSourceParser $parser) {
	 ...
	 *
	 * @param Tx_WildsideExtbase_Domain_Model_DataSource $dataSource the DataSource to display
	 * @return string The rendered view
	 */
	public function showAction(Tx_WildsideExtbase_Domain_Model_DataSource $dataSource) {
	 ...
	 *
	 * @param Tx_WildsideExtbase_Domain_Model_DataSource $newDataSource a fresh DataSource object which has not yet been added to the repository
	 * @return void
	 * @dontvalidate $newDataSource
	 */
	public function newAction(Tx_WildsideExtbase_Domain_Model_DataSource $newDataSource = null) {
	 ...
	 * @return void
	 */
	public function createAction(Tx_WildsideExtbase_Domain_Model_DataSource $newDataSource) {
	 ...
	 */
	public function editAction(Tx_WildsideExtbase_Domain_Model_DataSource $dataSource) {
		$this->view->assign('dataSource', $dataSource);
	}
	 ...
	 * @return
	 */
	public function updateAction(Tx_WildsideExtbase_Domain_Model_DataSource $dataSource) {
	 ...
	 *
	 * @param Tx_WildsideExtbase_Domain_Model_DataSource $dataSource the DataSource to be deleted
	 * @return void
	 */
	public function deleteAction(Tx_WildsideExtbase_Domain_Model_DataSource $dataSource) {
	...
	public function initializeAction() {
		$this->dataSourceRepository = t3lib_div::makeInstance(Tx_WildsideExtbase_Domain_Repository_DataSourceRepository);
	}
